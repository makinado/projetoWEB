              ...
              <v-flex xs12 md2>
                ...
                >
                  <v-tooltip slot="prepend" bottom>
                    ...
                    <span>Orçamentos não lançam estoque e financeiro</span>
                  </v-tooltip>
                </v-autocomplete>
              </v-flex>
              <v-flex xs12 md3>
...
export default {
  ...
  methods: {
    ...
    addProduto() {
      const sequencia = this.produtos_venda.length;
      const produto = {
        sequencia
      };
    ...
    parseValores() {
      ...
      this.financeiroStore.financ = this.venda.financeiro.map(parcela => {
