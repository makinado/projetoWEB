...
module.exports = app => {
    ...
    app.route('/pessoas/financeiro/:id')
        .all(app.config.passport.authenticate())
    ...
    app.route('/orcamentos/tela')
        .all(app.config.passport.authenticate())
        .get(app.api.vendas.orcamentos.getTela)
    app.route('/orcamentos/tela/:id')
        .all(app.config.passport.authenticate())
        .get(app.api.vendas.orcamentos.getTela)
    app.route('/orcamentos')
        .all(app.config.passport.authenticate())
        .post(app.api.vendas.orcamentos.save)
        .get(app.api.vendas.orcamentos.get)
    app.route('/orcamentos/:id')
        .all(app.config.passport.authenticate())
        .put(app.api.vendas.orcamentos.save)
        .get(app.api.vendas.orcamentos.getById)
        .delete(app.api.vendas.orcamentos.remove)
